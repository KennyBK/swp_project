                    ...
                    <div class="card-body">
                        <div class="col-lg-12 col-12 col-md-12 col-sm-12 row">
                            ...
                            <form class="col-12 row" method="get" id="filter" action="/TrainingSystem/manage/classevalcriteria/list">
                                ...
                                <div class="form-group row col-4 ml-0">
                                    <select  onchange="document.getElementById('filter').submit();" name="mId"  class="form-control" style="display: inline; width: 150px;">
                                        <option value="">All Milestones</option>
                                        <c:forEach var="m" items="${mlist}">
                                            <option value="${m.id}" ${param.mId==m.id?"selected":""}>${m.title}</option>
                                        </c:forEach>
                                            ...
                                            <tr>
                                                ...
                                                <c:if test="${!a.status}">
                                                    ...
                                                    <td><c:if test="${a.status}">
                                                        <a href="/TrainingSystem/Trainer/UpdateEvalStatus?eid=${a.id}&status=0""
                                                    ...
                                                    <c:if test="${not a.status}">
                                                        <a href="/TrainingSystem/Trainer/UpdateEvalStatus?eid=${a.id}&status=1""
